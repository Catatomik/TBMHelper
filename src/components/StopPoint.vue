              ...
              <div class="ml-2">
                <template v-for="schedule in schedules" :key="schedule.datetime">
                  <span
                    ...
                    :class="[
                      realtimeRoutesSchedules[routeId].route.stopPointDetails.schedules.destinations.length >
                      1
                        ? `dest-${realtimeRoutesSchedules[
                            routeId
                          ].route.stopPointDetails.schedules.destinations
                  ...
                  realtimeRoutesScheduleData.vehicle_position_updated_at.length
                    ? "±" +
                      duration(
                        now -
                          Date.parse(
                            realtimeRoutesScheduleData.vehicle_position_updated_at.replace(" ", "T"),
                          ),
                        true,
                        true,
                      )
